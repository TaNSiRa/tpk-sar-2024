...
List<ModelICP> modelICPFromJson(String str) =>
    List<ModelICP>.from(json.decode(str).map((x) => ModelICP.fromJson(x)));

String modelICPToJson(List<ModelICP> data) =>
...
class ModelICP {
  ...
  factory ModelICP.fromJson(Map<String, dynamic> json) => ModelICP(
        ...
        canEdit: false,
        w_1: json["W_1"] ?? "",
        volume_1: json["Volume_1"] ?? "",
        tW_1: json["TW_1"] ?? "",
        w_2: json["W_2"] ?? "",
        volume_2: json["Volume_2"] ?? "",
        tW_2: json["TW_2"] ?? "",
      );
