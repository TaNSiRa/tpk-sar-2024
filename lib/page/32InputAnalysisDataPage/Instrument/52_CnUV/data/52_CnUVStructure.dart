...
List<ModelCnUV> modelCnUVFromJson(String str) =>
    List<ModelCnUV>.from(json.decode(str).map((x) => ModelCnUV.fromJson(x)));

String modelCnUVToJson(List<ModelCnUV> data) =>
...
class ModelCnUV {
  ...
  factory ModelCnUV.fromJson(Map<String, dynamic> json) => ModelCnUV(
