...
List<ModelIC> modelICFromJson(String str) =>
    List<ModelIC>.from(json.decode(str).map((x) => ModelIC.fromJson(x)));

String modelICToJson(List<ModelIC> data) =>
...
class ModelIC {
  ...
  factory ModelIC.fromJson(Map<String, dynamic> json) => ModelIC(
