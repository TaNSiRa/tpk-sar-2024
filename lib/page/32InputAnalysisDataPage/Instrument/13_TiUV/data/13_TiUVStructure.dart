...
List<ModelTiUV> modelTiUVFromJson(String str) =>
    List<ModelTiUV>.from(json.decode(str).map((x) => ModelTiUV.fromJson(x)));

String modelTiUVToJson(List<ModelTiUV> data) =>
...
class ModelTiUV {
  ...
  factory ModelTiUV.fromJson(Map<String, dynamic> json) => ModelTiUV(
